...
const Navbar = () => {
  return (
    <header className="bg-white  ">
      <div className=" text-sm mx-auto h-7 items-center px-3 flex justify-between  bg-blue-900">
        ...
        <ui className="text-gray-200 ml-10 text-xs">mail: info@industrialcoolantsystems.com</ui>
      </div>
      {/* ------------------------------------------------------------------------------------------------------------- */}
      <nav className="sm:px-4 py-2.5 bg-white mx-auto  w-full z-20 flex justify-between border-b border-gray-200 dark:border-gray-600">
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          ...
          <div className=" md:w-full hidden  cursor-pointer max-w-xs  md:max-w-xl xl:max-w-4xl 2xl:max-w-5xl bg-gray-100 rounded-md  xl:flex items-center">
            <select className="bg-transparent  text-center uppercase font-bold text-sm p-4 mr-2">
      ...
      {/* ------------------------------------------------------------------------------------------------ */}
      <nav className="bg-gray-200  text-gray-800 hover:text-gray-700 text-xs sm:text-sm md:text-sm  lg:text-sm font-medium ">
