...
const Section2 = () => {
  return (
    <section className="overflow-hidden bg-gray-200 py-10  pb-12 ">
          ...
          <div className="w-full px-10 lg:w-6/12">
            <div className="-mx-3 flex items-center sm:-mx-4">
              <div className="w-full  sm:px-4 xl:w-1/2">
                ...
                >
                  <div className="text-lg md:text-3xl font-medium pb-2 md:pb-8 ">
                    About Us
                  </div>
                ...
                >
                  <div className=" mt-10  md:mt-20">
                    <img
                      src={Coolent2}
                      alt=""
                      className="w-full border border-black border-[6px] rounded-lg"
                    />
                  </div>
                </motion.div>
                <motion.div
            ...
            <div className="mt-10 lg:mt-0">
              ...
              >
                <p className="text-body-color mb-8 text-base">
                  ...
                  coolant systems for machine tool applications. ICS is a
                  relatively new company based out of Denver, Colorado with 35
                  years of combined experience in the Machine tool industry. As
                  we continue to grow, we are expanding our network of dealers
                  across the U.S. as well as internationally. We are dedicated
                  in providing high performance, low cost products to the
                  manufacturing industry.
                </p>
                <p className="text-body-color mb-12 text-base">
                  We have the capability to build custom coolant systems to meet
                  your specific requirements. Please visit our contact page and
