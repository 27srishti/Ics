    ...
    <section>
      <header className="relative  flex items-center justify-center h-auto  overflow-hidden">
        <div className="relative w-full bg-black">
          <div className="relative z-30 pt-5 px-0 py-5 pb-5 text-2xl text-white h-auto bg-black bg-opacity-80 ">
            <div className="text-white relative  ">
              <header className=" -mt-5 ">
                <div className=" text-sm mx-auto h-7 bg-gray-300 opacity-60 items-center px-3 flex justify-between  bg-gradient-to-r from-blu-600 to-gray-900">
                  ...
                  <ui className="text-gray-800 invisible lg:visible  md:visible text-xs">
            ...
            <div className=" md:w-60 hidden   invisible md:visible sm:flex  flex-col place-items-left">
              ...
              <div className="Max-w-[800px] font-Poppins  text-center  bg-black  md:w-[70%] mx-auto px-5 pt-8 md:pt-7  bg-blur-sm mt-3  mb-3 bg-opacity-50 rounded-lg text-center flex flex-col justify-center ">
                <div className="text-gray-300   md:text-4xl sm:text-5xl text-2xl font-bold font-Poppins ">
                  <motion.div
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true, amount: 0.5 }}
